...
```bash
git clone https://github.com/nandurpm/storage-forensics.git
cd storage-forensics
pnpm install
```
...
**Live URL:** [https://storage-forensics.onrender.com](https://storage-forensics.onrender.com)
